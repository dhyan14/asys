      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="mt-4 text-center">
            <Link href="/student/attendance" className="text-blue-600 hover:underline text-sm">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-lg font-semibold mb-4">Pending Leave Applications</h2>
          ...
          <div className="mt-4 text-center">
            <Link href="/student/leave" className="text-blue-600 hover:underline text-sm">
              Apply for Leave
            </Link>
          </div>
        </div>
